...
export class Element extends Node {
  ...
  get style() {
    const style = wrap(CSSStyleDeclaration, native.Element_style(this))
    Object.defineProperty(style, 'ownerNode', { value: this })
    Object.defineProperty(this, 'style', { value: style, enumerable: false })
